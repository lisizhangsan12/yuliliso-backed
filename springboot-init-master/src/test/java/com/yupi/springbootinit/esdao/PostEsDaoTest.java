...
public class PostEsDaoTest {
    ...
    void testAdd() {
        ...
        postEsDTO.setId(2L);
        postEsDTO.setTitle("鱼皮聚合搜索222");
        postEsDTO.setContent("知识星球学知识，做项目2");
        postEsDTO.setTags(Arrays.asList("java", "python","Js"));
    ...
    void testFindByTitle() {
        List<PostEsDTO> postEsDTOS = postEsDao.findByTitle("鱼");
